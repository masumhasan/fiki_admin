      ...
      <section className="overflow-hidden rounded-xl border border-[#e1e6ee] bg-card shadow-[0_4px_14px_rgba(15,37,74,.04)]">
        <div className="flex items-center justify-between border-b border-border px-5 py-5">
          ...
          <span className="text-[10px] text-muted-foreground font-medium">
            Pay Period: <strong>{payPeriodRange}</strong> · {completedTrips.length} completed trip{completedTrips.length !== 1 ? "s" : ""}
          </span>
        </div>
        {completedTrips.length === 0 ? (
          <div className="px-5 py-14 text-center">
            ...
            <p className="mt-3 text-sm font-semibold text-foreground">
              No completed trips found for this pay period
            </p>
            <p className="mt-1 text-xs text-muted-foreground">
              This driver has no completed trips recorded for <strong>{payPeriodRange}</strong>.
            </p>
          </div>
        ) : (
